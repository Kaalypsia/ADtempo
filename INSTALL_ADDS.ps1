...
Install-ADDSForest -DomainName $domainName -DomainNetbiosName "MONBUISSON" -ForestMode Win2022 -DomainMode Win2022 -SafeModeAdministratorPassword (ConvertTo-SecureString -AsPlainText "mdp123!" -Force)
